    ...
    <footer>
        <div class="row">
            <div class="col span-1-of-2">
                <ul class="footer-nav">
                    <li> <a href="https://gabrielrosas.herokuapp.com/" target="_blank">About us</a> </li>
                    <li> <a href="#">Blog</a> </li>
            ...
            <div class="col span-1-of-2">
                <ul class="social-links">
                    <li> <a href="https://github.com/shatorosas/ShatosKitchen" target="_blank"> <i class="icon ion-logo-github"></i></a> </li>
